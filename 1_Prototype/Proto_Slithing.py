...
class SlitherField(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.speed = 15                                                         #some Timing Measure
        self.timeHandling()
        self.move = 0
        self.gameStatus = 'Alive'
        self.initSlitherField()
        self.SlitherGame = list()                                               #Stores Every Move of the SlitherGame
        self.foodInit()
        self.score_label()
        self.restart_init()
        self.show()
    ...
    def mySlither(self, nslith):
        ...
        _tempx, _tempy = self.convCords(4,1, type='QT')
        ...
        if nslith >= 2:
            _tempx, _tempy = self.convCords(6,12, type='QT')
            self.mySlithers.append(Slither(_tempx,
                                           _tempy,
                                           self.slitherSize,
                                           indexNumber=1,
    ...
    def moveSlither(self):
        ...
        self.SlitherGame.append(self.slitherField)
        for slither in self.mySlithers:
            if slither != 'dead' and slither.controller != 'player':
