import os
os.chdir("C:/Users/Milan/Desktop/Coding/Python/Projects/1. Slithing/AI_Prototype/Dummy_Tests")
from Snake_edited import Game as game
import pygame
...
def create_dummy_model(training_data):
    ...
    model = create_nnm(input_size=len(X[0]), output_size=len(y[0]))
    return model
...
def create_nnm(input_size, output_size):
    model = tf.keras.Sequential([
        Dense(32, input_shape=(input_size,)),
        Activation('softmax'),
        Dense(32),
        Activation('softmax'),
        Dense(32),
