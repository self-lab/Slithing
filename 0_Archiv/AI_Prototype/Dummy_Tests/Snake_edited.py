...
class Game():
    ...
    def step(self, direction):
        """
        assuming the snake's current direction is up,
        direction 0 means the snake should go left
        direction 1 means the snake should go right
        direction 2 means the snake should go straight
